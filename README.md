...
#### 10. shift_entries（シフトエントリー）NEW!
- id: エントリーID
- vacancy_id: 欠員シフトID
- user_name: エントリーしたユーザー名
- entry_time: エントリー日時

#### 11. shift_pdf_links（シフトPDFリンク）NEW!
- id: リンクID
- title: タイトル
- pdf_url: Google Drive共有URL
- display_order: 表示順
...
### v2.1.0 (2025-01-05)
- ✅ テスト機能を削除（シンプル化）
- ✅ タブ順序を変更（ホーム、シフト、動画、チェック、ランキング、管理）
- ✅ シフト機能を追加
  - 欠員シフト募集機能
  - 募集人数とエントリー数の表示
  - PDFシフト表リンク管理
